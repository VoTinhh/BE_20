...
class BaiHocUpDateRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'tieu_de'       =>'required|min:3|max:50',
            'bai_hoc_so'    =>'required|numeric',
            'link_bai_hoc'  =>'required|min:10|max:300',
    ...
    {
        return [
            'id.required'           =>  'Bạn phải chọn bài học',
